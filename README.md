...
명령 팔레트에서 **아이젠하워 매트릭스 열기**를 실행합니다. 진행 중인 작업 카드를 끌거나 우클릭해 분면을 변경할 수 있습니다. 완료 카드는 완료 당시의 분류를 보존하기 위해 이동할 수 없습니다. 카드 본문을 클릭하면 매트릭스 화면을 유지한 채 Project Manager 작업 편집기를 엽니다. 우클릭 메뉴의 **작업 삭제**는 확인 후 Project Manager를 통해 하위 작업과 프로젝트 관계까지 함께 정리합니다.
