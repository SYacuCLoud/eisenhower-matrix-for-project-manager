...
명령 팔레트에서 **아이젠하워 매트릭스 열기**를 실행합니다. 작업 카드를 끌거나 우클릭해 분면을 변경할 수 있습니다. 카드 본문을 클릭하면 매트릭스 화면을 유지한 채 Project Manager 작업 편집기를 엽니다.
...
- 편집 호환 계층이 동작하지 않으면 작업 Markdown 노트를 열고, 생성 호환 계층이 동작하지 않으면 해당 프로젝트의 일반 작업 추가 창을 엽니다.
